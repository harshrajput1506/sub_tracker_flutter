...
/// Screen for editing an existing subscription
class EditSubscriptionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _EditSubscriptionContent(id: id),
    );
  }
}

class _EditSubscriptionContent extends StatefulWidget {
  final String id;

  const _EditSubscriptionContent({required this.id});

  @override
  State<_EditSubscriptionContent> createState() =>
      _EditSubscriptionContentState();
}

class _EditSubscriptionContentState extends State<_EditSubscriptionContent> {
  ...
  void _initializeForm(SubscriptionModel subscription) {
    ...
    return BlocConsumer<SubscriptionBloc, SubscriptionState>(
      listener: (context, state) {
        ...
        if (state is SubscriptionOperationSuccess) {
          ...
          _initializeForm(state.subscription);
        }
      },
      builder: (context, state) {
        if (state is SubscriptionLoading && !_isInitialized) {
          return Scaffold(
            appBar: CustomAppBar(
